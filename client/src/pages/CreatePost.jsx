...
const CreatePost = () => {
  ...
  const generateImage=async()=>{
    if(form.prompt){
      try{
        ...
        const response= await fetch(`https://dall-e-iss7.onrender.com/api/v1/dalle`,{
          method:'POST',
          headers:{
  ...
  const handleSubmit=async(e)=>{  
    ...
    try {
      const response= await fetch('https://dall-e-iss7.onrender.com/api/v1/post',{
        method:'POST',
        headers:{
          'Content-Type': 'application/json',
        },
  ...
  return (
    ...
    <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
      ...
      <div className='mt-10'>
            <p className='mt-2 text-[#667e75] text-[14px]'>Once you have created the image you want, you can
               share it with others in the comunity</p>
            <button
              type='submit'
